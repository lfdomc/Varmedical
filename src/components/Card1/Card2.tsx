...
const ImageGallery2 = () => {
  const images = [
    { id: 1, src: '/image/var/cristal.jpg', alt: 'Equipos de Cristalería', text: 'Cristalería', link: '/page1' },
    { id: 2, src: '/image/var/muestra.png', alt: 'Toma de muestras', text: 'Insumos para toma de muestras', link: '/page2' },
