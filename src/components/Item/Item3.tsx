  ...
  const medicalEquipments: MedicalEquipment[] = [
    {
      ...
      title: "BIOBAS 10",
      description:
        "• Instrumento monocanal de fácil uso\n• Con microprocesador para programar parámetrosy realizar cálculos",
      imageUrl: "/image/var/equipos/coagula/biobas10.webp", // Imagen de ejemplo
      pdfUrl: "/image/var/equipos/coagula/biobas_10-20-40.pdf", // Ruta del PDF de ejemplo
    ...
    },
    {
      ...
      title: "BIOBAS 20/40",
      description:
        "• Coagulómetro de dos / cuatro canales\n• Fácil de usar\n• Versátil\n• Con microprocesador para",
      imageUrl: "/image/var/equipos/coagula/biobas20.webp", // Imagen de ejemplo
      pdfUrl: "/image/var/equipos/coagula/biobas_10-20-40.pdf", // Ruta del PDF de ejemplo
      youtubeVideoId: "", // Ejemplo de ID de video de YouTube
    },
    {
      ...
      title: "BIOBAS 1000",
      description:
        "• Coagulómetro Automático\n• Capacidad de carga para 22 muestras\n• 15 posiciones para reactivo\n• Dilución automática de muestras\n• Estación de lavado\n• Lector código de barras opcional",
      imageUrl: "/image/var/equipos/coagula/biobas1000.webp", // Imagen de ejemplo
      pdfUrl: "/image/var/equipos/coagula/BIOBAS1000.pdf", // Ruta del PDF de ejemplo
      youtubeVideoId: "", // Ejemplo de ID de video de YouTube
    },
  ];
