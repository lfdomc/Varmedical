  ...
  const medicalEquipments: MedicalEquipment[] = [
    {
      ...
      title: "SPINCELL 3n",
      description:
        "•Analizador Hematológico 3 Diff\n• Pantalla grande de color LCD y sistema operativo Linux\n• Excelente gestión de los datos con el ratón y teclado\n• Sistema de auto-verificación de alta eficaciabajo mantenimiento\n• Soporte LIS y HIS con protocolo HL7",
      imageUrl: "/image/var/equipos/hemato/spincell-3.webp", // Imagen de ejemplo
      pdfUrl: "/image/var/equipos/hemato/Spincell3.pdf", // Ruta del PDF de ejemplo
      youtubeVideoId: "xnvlcUrInVE", // Ejemplo de ID de video de YouTube
    },
    {
      id: 2,
      title: "SPINCELL 5 plus",
      description:
        "• Analizador Hematológico 5 Diff\n• Láser de clasificación celular multidimensional\n• Hasta 60 muestras por hora\n• Diferenciación de WBC en 5 partes\n• Cargador automático con 50 posiciones\n• Cuatro reactivos para el análisis 25 parámetros",
      imageUrl: "/image/var/equipos/hemato/spincell5plus.webp", // Imagen de ejemplo
      pdfUrl: "/image/var/equipos/hemato/Spincell5plus.pdf", // Ruta del PDF de ejemplo
      youtubeVideoId: "", // Ejemplo de ID de video de YouTube
    },
    {
      id: 3,
      title: "SPINCELL 5 compact",
      description:
        "• Analizador Hematológico 5 Diff\n• Láser de clasificación celular multidimensional\n• Hasta 60 muestras por hora\n• Diferenciación de WBC en 5 partes\n• Analiza tanto muestras de sangre total como de sangre capilar\n• Cuatro reactivos para el análisis 25 parámetros",
      imageUrl: "/image/var/equipos/hemato/spincell5compact.webp", // Imagen de ejemplo
      pdfUrl: "/image/var/equipos/hemato/Spincell_5compact.pdf", // Ruta del PDF de ejemplo
      youtubeVideoId: "", // Ejemplo de ID de video de YouTube
    },
  ];
