          ...
          <div className="flex flex-col items-center md:items-start">
            <Link href="/" aria-label="Volver al inicio">
              <Image
                ...
                width={150}
                height={150}
                className="mb-4 w-auto h-auto" // Corrección aquí
              />
            </Link>
            ...
            <div className="flex space-x-4 mt-4">
              ...
              >
                <Image
                  ...
                  width={24}
                  height={24}
                  className="hover:opacity-80 transition-opacity w-auto h-auto" // Corrección aquí
                />
              </a>
              <a
