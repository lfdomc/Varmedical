...
export default function Home() {
  return (
    <>
      <Head>
        <title>Var Medical | Equipos Médicos y Reactivos para Laboratorio</title>
        ...
        <meta property="og:description" content="Var Medical es una empresa que provee equipo médico y reactivos para Laboratorios en Costa Rica." />
