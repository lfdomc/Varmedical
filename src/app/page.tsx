...
export default function Home() {
  return (
    <>
      <Head>
        <title>Var Medical | Equipos Médicos y Servicios de Mantenimiento</title>
        <meta name="description" content="Var Medical es una empresa que provee equipo médico y servicios de mantenimiento a diferentes sectores de la salud en Costa Rica. Ofrecemos soluciones innovadoras y confiables." />
